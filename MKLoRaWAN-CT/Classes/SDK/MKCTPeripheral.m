...
@interface MKCTPeripheral ()

@property (nonatomic, strong)CBPeripheral *peripheral;

@end

@implementation MKCTPeripheral
...
- (void)updateCharacterWithService:(CBService *)service {
    [self.peripheral ct_updateCharacterWithService:service];
}

- (void)updateCurrentNotifySuccess:(CBCharacteristic *)characteristic {
    [self.peripheral ct_updateCurrentNotifySuccess:characteristic];
}

- (BOOL)connectSuccess {
    return [self.peripheral ct_connectSuccess];
}

- (void)setNil {
    [self.peripheral ct_setNil];
}
