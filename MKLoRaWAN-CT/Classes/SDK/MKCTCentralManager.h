...
extern NSString *const mk_ct_peripheralConnectStateChangedNotification;

//Notification of changes in the status of the Bluetooth Center.
extern NSString *const mk_ct_centralManagerStateChangedNotification;
 ...
 */
extern NSString *const mk_ct_deviceDisconnectTypeNotification;

@class CBCentralManager,CBPeripheral;
@class MKCTOperation;

@interface MKCTCentralManager : NSObject<MKBLEBaseCentralManagerProtocol>

@property (nonatomic, weak)id <mk_ct_centralManagerScanDelegate>delegate;

@property (nonatomic, weak)id <mk_ct_centralManagerLogDelegate>logDelegate;

/// Current connection status
@property (nonatomic, assign, readonly)mk_ct_centralConnectStatus connectStatus;

+ (MKCTCentralManager *)shared;

/// Destroy the MKCTCentralManager singleton and the MKBLEBaseCentralManager singleton. After the dfu upgrade, you need to destroy these two and then reinitialize.
+ (void)sharedDealloc;

/// Destroy the MKCTCentralManager singleton and remove the manager list of MKBLEBaseCentralManager.
