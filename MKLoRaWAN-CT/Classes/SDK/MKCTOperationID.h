...
#pragma mark - 电池管理参数
    mk_ct_taskReadAllCycleBatteryInformationOperation,  //读取所有周期电池电量消耗
...
#pragma mark - 模式相关参数读取
    ...
    mk_ct_taskReadMotionModeEventsNotifyEventOnStartOperation,      //读取运动模式-运动开始事件信息开关
    mk_ct_taskReadMotionModeEventsFixOnStartOperation,              //读取运动模式-运动开始定位开关
    ...
    mk_ct_taskReadMotionModeEventsNotifyEventInTripOperation,       //读取运动模式-运动中事件信息开关
    mk_ct_taskReadMotionModeEventsFixInTripOperation,               //读取运动模式-运动中定位开关
    ...
    mk_ct_taskReadMotionModeEventsNotifyEventOnEndOperation,      //读取运动模式-运动结束事件信息开关
    mk_ct_taskReadMotionModeEventsFixOnEndOperation,              //读取运动模式-运动结束定位开关
    ...
    mk_ct_taskReadMotionModeEventsFixOnStationaryStateOperation,    //读取运动模式-静止定位开关
    ...
    mk_ct_taskReadTimeSegmentedModeStrategyOperation,               //读取定时+定期模式-定位策略
    mk_ct_taskReadTimeSegmentedModeTimePeriodSettingOperation,      //读取定时+定期模式-定时时间段
...
#pragma mark - 蓝牙扫描过滤参数读取
    ...
    mk_ct_taskReadFilterByBXPTagIDStatusOperation,         //读取BXP-T&S TagID类型开关
    mk_ct_taskReadPreciseMatchTagIDStatusOperation,        //读取BXP-T&S TagID类型精准过滤tagID开关
    mk_ct_taskReadReverseFilterTagIDStatusOperation,    //读取读取BXP-T&S TagID类型反向过滤tagID开关
    mk_ct_taskReadFilterBXPTagIDListOperation,             //读取BXP-T&S TagID过滤规则
...
#pragma mark - 定位参数读取
    ...
    mk_ct_taskReadBeaconVoltageReportInBleFixOperation, //读取蓝牙beacon电压上报开关
...
#pragma mark - 电池参数
    mk_ct_taskBatteryResetOperation,                    //清除电池电量数据
...
#pragma mark - 配置模式相关参数
    ...
    mk_ct_taskConfigMotionModeEventsNotifyEventOnStartOperation,    //配置运动模式-运动开始事件信息开关
    mk_ct_taskConfigMotionModeEventsFixOnStartOperation,            //配置运动模式-运动开始定位开关
    ...
    mk_ct_taskConfigMotionModeEventsNotifyEventInTripOperation,     //配置运动模式-运动中事件信息开关
    mk_ct_taskConfigMotionModeEventsFixInTripOperation,             //配置运动模式-运动中定位开关
    ...
    mk_ct_taskConfigMotionModeEventsNotifyEventOnEndOperation,      //配置运动模式-运动结束事件信息开关
    mk_ct_taskConfigMotionModeEventsFixOnEndOperation,              //配置运动模式-运动结束定位开关
    ...
    mk_ct_taskConfigMotionModeEventsFixOnStationaryStateOperation,  //配置运动模式-静止定位开关
    ...
    mk_ct_taskConfigTimeSegmentedModeStrategyOperation,             //配置定时+定期模式-定位策略
    mk_ct_taskConfigTimeSegmentedModeTimePeriodSettingOperation,    //配置定时+定期模式-定时时间段
...
#pragma mark - 蓝牙扫描过滤参数配置
    ...
    mk_ct_taskConfigFilterByBXPTagIDStatusOperation,            //配置BXP-T&S TagID类型过滤开关
    mk_ct_taskConfigPreciseMatchTagIDStatusOperation,           //配置BXP-T&S TagID类型精准过滤Tag-ID开关
    mk_ct_taskConfigReverseFilterTagIDStatusOperation,          //配置BXP-T&S TagID类型反向过滤Tag-ID开关
    mk_ct_taskConfigFilterBXPTagIDListOperation,                //配置BXP-T&S TagID过滤规则
...
#pragma mark - 设备LoRa参数读取
    ...
    mk_ct_taskReadManDownDetectionPayloadDataOperation,     //读取闲置检测包上行配置
...
#pragma mark - 设备LoRa参数配置
    ...
    mk_ct_taskConfigManDownDetectionPayloadOperation,   //配置闲置检测包上行配置
...
#pragma mark - 定位参数配置
    ...
    mk_ct_taskConfigBeaconVoltageReportInBleFixStatusOperation, //配置蓝牙beacon电压上报开关
