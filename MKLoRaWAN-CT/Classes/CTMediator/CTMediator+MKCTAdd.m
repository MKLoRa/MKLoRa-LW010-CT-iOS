...
@implementation CTMediator (MKCTAdd)

- (UIViewController *)CTMediator_LORAWAN_CT_AboutPage {
    ...
    return [self performTarget:kTarget_loRaApp_ct_module
                        action:kAction_loRaApp_ct_aboutPage
                        params:@{}
             shouldCacheTarget:NO];
}
