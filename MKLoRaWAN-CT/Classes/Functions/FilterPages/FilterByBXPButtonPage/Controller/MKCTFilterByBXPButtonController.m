//
//  MKCTFilterByBXPButtonController.m
...
@interface MKCTFilterByBXPButtonController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCTFilterByBXPButtonModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKCTFilterByBXPButtonController

- (void)dealloc {
    NSLog(@"MKCTFilterByBXPButtonController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-CT", @"MKCTFilterByBXPButtonController", @"ct_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCTFilterByBXPButtonModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCTFilterByBXPButtonModel alloc] init];
    }
    return _dataModel;
}
