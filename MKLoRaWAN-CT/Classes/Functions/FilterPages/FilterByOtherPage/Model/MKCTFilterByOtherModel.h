...
@interface MKCTFilterRawAdvDataModel : NSObject<mk_ct_BLEFilterRawDataProtocol>
...
@interface MKCTFilterByOtherModel : NSObject
...
- (void)configWithRawDataList:(NSArray <MKCTFilterRawAdvDataModel *>*)list
                 relationship:(mk_ct_filterByOther)relationship
