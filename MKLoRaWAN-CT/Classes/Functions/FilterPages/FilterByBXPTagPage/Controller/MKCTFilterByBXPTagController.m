//
//  MKCTFilterByBXPTagController.m
...
@interface MKCTFilterByBXPTagController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCTFilterByBXPTagModel *dataModel;

@end

@implementation MKCTFilterByBXPTagController

- (void)dealloc {
    NSLog(@"MKCTFilterByBXPTagController销毁");
}
...
- (MKCTFilterByBXPTagModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCTFilterByBXPTagModel alloc] init];
    }
    return _dataModel;
}
