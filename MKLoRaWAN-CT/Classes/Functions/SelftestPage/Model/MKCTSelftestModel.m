...
@implementation MKCTSelftestModel
...
- (BOOL)readPCBAStatus {
    ...
    [MKCTInterface ct_readPCBAStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSelftestStatus {
    __block BOOL success = NO;
    [MKCTInterface ct_readSelftestStatusWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
