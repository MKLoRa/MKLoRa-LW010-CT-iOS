...
@implementation MKCTPCBAStatusCellModel
@end

@interface MKCTPCBAStatusCell ()
...
@implementation MKCTPCBAStatusCell

+ (MKCTPCBAStatusCell *)initCellWithTableView:(UITableView *)tableView {
    MKCTPCBAStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCTPCBAStatusCellIdenty"];
    if (!cell) {
        cell = [[MKCTPCBAStatusCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCTPCBAStatusCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKCTPCBAStatusCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCTPCBAStatusCellModel.class]) {
        return;
    }
