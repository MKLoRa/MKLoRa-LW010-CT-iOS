...
@implementation MKCTSelftestCellModel
@end

@interface MKCTSelftestCell ()
...
@implementation MKCTSelftestCell

+ (MKCTSelftestCell *)initCellWithTableView:(UITableView *)tableView {
    MKCTSelftestCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCTSelftestCellIdenty"];
    if (!cell) {
        cell = [[MKCTSelftestCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCTSelftestCellIdenty"];
    }
    return cell;
}
...
#pragma mark - setter
- (void)setDataModel:(MKCTSelftestCellModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCTSelftestCellModel.class]) {
        return;
    }
