...
@interface MKCTDownlinkController ()<UITableViewDelegate,
...
@implementation MKCTDownlinkController

- (void)dealloc {
    NSLog(@"MKCTDownlinkController销毁");
}
...
- (void)readDataFromDevice {
    ...
    [MKCTInterface ct_readDownlinkPositioningStrategyWithSucBlock:^(id  _Nonnull returnData) {
...
- (void)configDownlinkForPositioningStrategy:(NSInteger)strategy {
    ...
    [MKCTInterface ct_configDownlinkPositioningStrategy:strategy sucBlock:^{
        [[MKHudManager share] hide];
