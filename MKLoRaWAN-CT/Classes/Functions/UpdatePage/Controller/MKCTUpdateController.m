...
@interface MKCTUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCTDFUModule *dfuModule;
...
@implementation MKCTUpdateController

- (void)dealloc {
    NSLog(@"MKCTUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ct_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKCTCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_ct_centralDeallocNotification" object:nil];
...
- (MKCTDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKCTDFUModule alloc] init];
    }
    return _dfuModule;
}
