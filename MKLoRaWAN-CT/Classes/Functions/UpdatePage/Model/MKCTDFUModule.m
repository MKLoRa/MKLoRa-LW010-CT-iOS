...
@interface MKCTDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKCTDFUModule

- (void)dealloc{
    NSLog(@"MKCTDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKCTCentralManager shared].peripheral];
}
