...
@interface MKCTMotionModeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCTMotionModeModel *dataModel;

@end

@implementation MKCTMotionModeController

- (void)dealloc {
    NSLog(@"MKCTMotionModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-CT", @"MKCTMotionModeController", @"ct_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCTMotionModeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCTMotionModeModel alloc] init];
    }
    return _dataModel;
}
