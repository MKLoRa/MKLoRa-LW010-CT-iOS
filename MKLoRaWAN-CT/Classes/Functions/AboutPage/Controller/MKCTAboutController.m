...
@implementation MKCTAboutController

- (void)dealloc {
    NSLog(@"MKCTAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-CT", @"MKCTAboutController", @"ct_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-CT", @"MKCTAboutController", @"ct_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
