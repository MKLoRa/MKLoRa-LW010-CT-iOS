...
@interface MKCTMessageTypeModel : NSObject

@property (nonatomic, assign)NSInteger deviceInfoType;

@property (nonatomic, assign)NSInteger deviceInfoMaxTimes;
