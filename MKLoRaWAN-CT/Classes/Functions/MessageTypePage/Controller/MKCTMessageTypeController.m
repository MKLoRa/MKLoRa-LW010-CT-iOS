...
@interface MKCTMessageTypeController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCTMessageTypeModel *dataModel;

@end

@implementation MKCTMessageTypeController

- (void)dealloc {
    NSLog(@"MKCTMessageTypeController销毁");
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (section == 0) {
        return (self.dataModel.deviceInfoType == 1 ? self.section6List.count : 1);
    }
    if (section == 1) {
    ...
    if (section == 3) {
        return (self.dataModel.lowPowerType == 1 ? self.section3List.count : 1);
    }
    if (section == 4) {
    ...
    if (section == 6) {
        return (self.dataModel.eventType == 1 ? self.section6List.count : 1);
    }
    if (section == 7) {
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 0) {
        ...
        self.dataModel.deviceInfoType = dataListIndex;
    ...
    if (index == 1) {
        ...
        cellModel.dataListIndex = dataListIndex;
        self.dataModel.deviceInfoMaxTimes = dataListIndex;
        return;
    }
    if (index == 2) {
...
- (void)loadSection0Datas {
    ...
    cellModel1.dataListIndex = self.dataModel.deviceInfoType;
    ...
    cellModel2.dataListIndex = self.dataModel.deviceInfoMaxTimes;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-CT", @"MKCTMessageTypeController", @"ct_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCTMessageTypeModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCTMessageTypeModel alloc] init];
    }
    return _dataModel;
}
