...
@interface MKCTTimeSegmentedCellModel : NSObject
...
@protocol MKCTTimeSegmentedCellDelegate <NSObject>
...
///   - index: 当前cell所在index
///   - interval: 当前输入框内容
- (void)ct_timeSegmentedCell_reportIntervalChanged:(NSInteger)index interval:(NSString *)interval;
...
@interface MKCTTimeSegmentedCell : MKBaseCell

@property (nonatomic, strong)MKCTTimeSegmentedCellModel *dataModel;

@property (nonatomic, weak)id <MKCTTimeSegmentedCellDelegate>delegate;
