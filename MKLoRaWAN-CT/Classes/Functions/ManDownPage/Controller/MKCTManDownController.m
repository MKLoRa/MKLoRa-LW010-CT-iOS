...
@interface MKCTManDownController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCTManDownDataModel *dataModel;

@property (nonatomic, strong)NSMutableArray *headerList;

@end

@implementation MKCTManDownController

- (void)dealloc {
    NSLog(@"MKCTManDownController销毁");
}
...
- (void)loadSection4Datas {
    ...
    cellModel2.isOn = self.dataModel.endIsOn;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaWAN-CT", @"MKCTManDownController", @"ct_slotSaveIcon.png") forState:UIControlStateNormal];
...
- (MKCTManDownDataModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCTManDownDataModel alloc] init];
    }
    return _dataModel;
}
