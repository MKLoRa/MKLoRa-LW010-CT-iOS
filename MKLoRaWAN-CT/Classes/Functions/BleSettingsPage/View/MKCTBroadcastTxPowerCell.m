...
@implementation MKCTBroadcastTxPowerCellModel
@end

@interface MKCTBroadcastTxPowerCell ()
...
@implementation MKCTBroadcastTxPowerCell

+ (MKCTBroadcastTxPowerCell *)initCellWithTableView:(UITableView *)tableView {
    MKCTBroadcastTxPowerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MKCTBroadcastTxPowerCellIdenty"];
    if (!cell) {
        cell = [[MKCTBroadcastTxPowerCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"MKCTBroadcastTxPowerCellIdenty"];
    }
    return cell;
}
...
- (void)txPowerSliderValueChanged {
    ...
    if ([self.delegate respondsToSelector:@selector(ct_txPowerValueChanged:)]) {
        [self.delegate ct_txPowerValueChanged:(NSInteger)self.slider.value];
    }
}
...
#pragma mark - setter
- (void)setDataModel:(MKCTBroadcastTxPowerCellModel *)dataModel {
    _dataModel = nil;
