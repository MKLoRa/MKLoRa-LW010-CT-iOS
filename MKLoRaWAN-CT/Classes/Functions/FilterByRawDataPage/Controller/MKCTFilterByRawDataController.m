...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0 && indexPath.row == 0) {
        ...
        MKCTFilterByBeaconModel *model = [[MKCTFilterByBeaconModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 1) {
        ...
        MKCTFilterByUIDModel *model = [[MKCTFilterByUIDModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 2) {
        ...
        MKCTFilterByURLModel *model = [[MKCTFilterByURLModel alloc] init];
    ...
    if (indexPath.section == 0 && indexPath.row == 3) {
        ...
        MKCTFilterByTLMModel *model = [[MKCTFilterByTLMModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 0) {
        ...
        MKCTFilterByBXPButtonModel *model = [[MKCTFilterByBXPButtonModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 1) {
        ...
        MKCTFilterByBXPTagModel *model = [[MKCTFilterByBXPTagModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 2) {
        ...
        MKCTFilterByPirModel *model = [[MKCTFilterByPirModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 3) {
        ...
        MKCTFilterByTofModel *model = [[MKCTFilterByTofModel alloc] init];
    ...
    if (indexPath.section == 2 && indexPath.row == 4) {
        ...
        MKCTFilterByOtherModel *model = [[MKCTFilterByOtherModel alloc] init];
